...
def document_search(input_text: str) -> str:
    return _run_named_tool("document_search", input_text)


def context_formatter(input_text: str) -> str:
    return _run_named_tool("context_formatter", input_text)
...
def get_tools() -> dict[str, Callable[[str], str]]:
    ...
    tools["context_formatter"] = context_formatter
