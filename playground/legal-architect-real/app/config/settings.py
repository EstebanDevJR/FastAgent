...
@dataclass
class Settings:
    app_name: str = os.getenv("APP_NAME", "legal-architect-real")
    ...
    vector_db: str = os.getenv("VECTOR_DB", "Pinecone")
    memory_type: str = os.getenv("MEMORY_TYPE", "vector")
    ...
    architect_provider: str = os.getenv("ARCHITECT_PROVIDER", "openai")
    architect_model: str = os.getenv("ARCHITECT_MODEL", "gpt-4o-mini")
