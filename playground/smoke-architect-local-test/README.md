...
- Architect notes: RAG pipeline enabled with retriever abstraction. | Legal workflow detected: specialized contract tools suggested. | High-risk domain detected: evaluation forced on by default.
